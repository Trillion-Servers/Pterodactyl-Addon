...
exports.run = async (client, message, args, level, ) => {
    ...
    try {
        Node.rebuild(serverid);
        const successEmbed = new Discord.RichEmbed()
            .setColor('#2dce89')
            .setAuthor('Success')
            .setDescription('The server has been Rebuilt')
            .setTimestamp()
        ...
        const errorEmbed = new Discord.RichEmbed()
            .setColor('#f5365c')
            .setAuthor('Error')
            .setDescription('The server has failed to be Rebuilt')
            .setTimestamp()
            .setFooter('Pterodactyl');
...
exports.help = {
    name: pterodactyl.settings.Rebuild_Command,
}