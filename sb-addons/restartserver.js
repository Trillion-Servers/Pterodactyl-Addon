// SupportBot Resource
// Pterodactyl RestartServer Command
// Creator: Griffindor
...
exports.run = async (client, message, args, level, ) => {
    ...
    console.log(`\x1b[36m`, `${message.author} has executed ${bot.settings.prefix}${pterodactyl.settings.RestartServer_Command}`)
    ...
    let serverid = args[0];
    Node.restartServer(serverid);
};

exports.help = {
    name: pterodactyl.settings.RestartServer_Command,
}