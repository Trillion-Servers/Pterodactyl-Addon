...
exports.run = async (client, message, args, level, ) => {
    ...
    console.log(`\x1b[36m`, `${message.author} has executed ${bot.settings.prefix}${pterodactyl.settings.EveryServer_Command}`)
    ...
    Node.getEveryLastServer().then(response => {
...
exports.help = {
    name: pterodactyl.settings.EveryServer_Command,
}